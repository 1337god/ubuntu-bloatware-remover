...
subprocess.Popen( 'apt-get install xauth xorg openbox obconf lightdm lightdm-webkit-greeter xfce4 xfce4-goodies gnome-icon-theme -y', shell=True, stdout=subprocess.PIPE ).communicate()[0]
